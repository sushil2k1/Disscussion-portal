...
let i=0;
function seting_time(dateOfUpload){
...
function createElement(obj) {
    ...
    // time.style.marginLeft="78%"
    // time.style.width="110px"


    time.innerHTML=seting_time(obj.t);
    setInterval(()=>{
        time.innerHTML=seting_time(obj.t);
...
cont.addEventListener("click", function (e) {
    ...
    function createResponse(arr) {
        ...
        votesDisplay.style.marginLeft="60%"
    ...
    resSubBtn.addEventListener('click', function () {
        ...
        if(resObj.name.trim()==="" || resObj.comment.trim()===""){
